...
class YOLO(object):
    _defaults = {
        # For Chris:
        "model_path": 'model_data/trained_weights_final_fulluntouch1050.h5', # change path and weights number here
        "anchors_path": 'model_data/yolo_anchors_full_untouch.txt',
